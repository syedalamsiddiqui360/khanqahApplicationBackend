...
export declare type IDetails = IBancontactDetails | IBankTransferDetails | IBelfiusPayButtonDetails | IBitcoinDetails | ICreditCardDetails | IGiftCardDetails | IIdealDetails | IIngHomePayDetails | IKbcCbcPaymentButtonDetails | IPayPalDetails | IPaysafecardDetails | ISepaDirectDebitDetails | ISofortBankingDetails;
/**
 * Bancontact details
 *
