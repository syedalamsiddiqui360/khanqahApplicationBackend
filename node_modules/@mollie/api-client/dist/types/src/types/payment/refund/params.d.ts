 ...
 *
 * @param amount - The amount to refund. For some payments, it can be up to €25.00 more than the original
 *                 transaction amount.
 ...
 *
 * @param testmode - Set this to `true` to get a refund made in test mode. If you omit this parameter, you can only
 *                   retrieve live mode refunds.
 *
 ...
 * @param paymentId - The corresponding Payment ID
 *
 * @param from - Offset the result set to the refund with this ID. The refund with this ID is included in the result
 *               set as well.
 ...
 * @param testmode - Set this to true to only retrieve refunds made in test mode. By default, only live payments are
 *                   returned.
 *
