 ...
 *                 chosen payment method. The parameter enables you to fully integrate the payment method selection into
 *                 your website.
 * @param customerId - The ID of the Customer for whom the payment is being created. This is used for recurring payments
 ...
 * @param applicationFee - Adding an application fee allows you to charge the merchant a small sum for the payment and
